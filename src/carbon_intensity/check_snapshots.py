"""Small offline check: python -m carbon_intensity.check_snapshots."""
...
from .forecasting import BUCKETS, HORIZON, design
...
from .selection import Candidate, predict_validation, select
